...
c=document.getElementById("timer-div");$(c).slideUp("slow")}if(null!==a){mssofar=(new Date).getTime()-startms;a=delaysofar+b-mssofar;0>a&&(a=1);timeOfNextTweet=(new Date).getTime()+a;timeout=setTimeout("showIt()",a);firstTweetLoaded?document.getElementById("timer").className="not-blinking":(firstTweetLoaded=!0,pauseText="Press here to continue when you have started the music ",document.getElementById("stand-by-arrow").style.display="block",playPause());var d=setInterval(function(){if(paused)document.getElementById("timer").innerHTML=
