...
b.status+" - "+c+"]");else{console.log("404 - tweet deleted");b=document.getElementById("tweet-feed-"+a);c=b.style.display;b.style="border-radius:15px;border:1px solid #ccc;padding:5px;width:100%;max-width:550px;margin-top:5px;";b.style.display=c;c="@"+b.innerHTML.trim();e=b.getAttribute("data-datetime");var f=b.getAttribute("data-text");if(null===f||3>f.length)f="This tweet has been deleted";var d="main-colour";1===darkMode&&(d="dark-main-colour");b.innerHTML='<table style="width:98%;max-width:550px;"><tr><td style="text-align:left;width:1%;padding-right:7px;vertical-align:top;"><img src="../../img/twitter.png" alt="CD" width="45px"></td><td class="'+
d+'" style="text-align:left;width:100%;"><b>'+c+'</b><div class="'+d+'" style="line-height:1.1em;">'+f+'</div><div style="font-size:0.8em;padding-top:2px;line-height:1.1em;color:#777777;">'+e+"</div></td></tr></table>";4>a&&(loadTweet(a+1),0===a&&(timeout=setTimeout("showIt()",250)))}}}))}
...
counter++,a=document.getElementById("tweet-feed-"+counter),null!==a)b=Number($(a).attr("data-delay")),loadTweet(counter+4);else{var d=document.getElementById("tweet-feed-"+(counter-1));$(d).slideDown("slow");d=document.getElementById("timer-div");$(d).slideUp("slow");ga("send",{hitType:"event",eventCategory:"feed",eventAction:"ended",eventLabel:urlpage})}if(null!==a){mssofar=(new Date).getTime()-startms;a=delaysofar+b-mssofar;0>a&&(a=1);timeOfNextTweet=(new Date).getTime()+a;timeout=setTimeout("showIt()",
...
function updateNowPlaying(a){var b=document.getElementById("now-playing");if(null!==b){b.style.display="block";b=document.getElementsByClassName("track-list");var d=a/1E3;a=-1;for(var c=1;c<b.length;c++)if(b[c].getAttribute("data-start")>d){a=c-1;break}-1===a&&(a=b.length-1);c=b[a];var e=c.getAttribute("data-start"),f=document.getElementById("track-time"),g=document.getElementById("track-title");e=d-e;d=Math.floor(e/60);e="0"+Math.floor(e%60);g.innerHTML=c.getAttribute("data-name");f.innerHTML=a<
b.length-1?d+":"+e.substr(e.length-2):""}}
