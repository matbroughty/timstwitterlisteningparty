...
document.getElementById("stand-by-arrow").style.display="none";document.getElementById("darkmode-row").style.display="none";pauseText="Paused"}else paused=!0,document.getElementById("play-pause-btn").className="fas fa-play",document.getElementById("playpause").style.display="block",document.getElementById("advance").style.display="none",pausedTime=(new Date).getTime(),clearTimeout(timeout),ga("send",{hitType:"event",eventCategory:"feed",eventAction:"paused",eventLabel:urlpage+" - tweet-feed-"+counter})}
...
a);firstTweetLoaded?(document.getElementById("timer").classList.remove("blinking"),document.getElementById("timer").classList.remove("blinking-dark"),document.getElementById("timer").classList.add("not-blinking")):(firstTweetLoaded=!0,pauseText="Press here to continue when you have started the music ",document.getElementById("stand-by-arrow").style.display="block",document.getElementById("darkMode").style.display="block",playPause());var d=setInterval(function(){if(paused)document.getElementById("timer").innerHTML=
pauseText;else{var a=timeOfNextTweet-(new Date).getTime();a=Math.floor(a/1E3);1>a?(clearInterval(d),document.getElementById("timer").innerHTML="Next tweet coming up..."):document.getElementById("timer").innerHTML="Next tweet in "+a+(1!==a?" seconds":" second")}},1E3)}}}
